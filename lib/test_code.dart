...
//   @override
//   State<TestCode> createState() => TestCodeState();
// }

// class TestCodeState extends State<TestCode> {
//   int currentStep = 0;
...
// Future<String?> getAvailableId() async {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextField(
              ...
              onChanged: (value) {
                // Do something with the text input if needed
              },
            ),
          ],
        ),
